export const cartaData = {
  ...
  PASTAS: {
    ...
    subcategorias: {
      ...
      "Pastas": {
        items: [
          { nombre: "Sorrentinos de Jamón y Queso", precio: "650 + una salsa elegible" },
  ...
  ENSALADAS: {
    tipo: "simple",
    items: [
      { nombre: "'Don Quijote'", precio: 490, descripcion: "(lechuga, tomate, zanahoria, morrón, aceitunas, palmitos, huevos, cebolla, pepinos)" },
      ...
      { nombre: "Ensalada de Camarón", descripcion: "(lechuga, tomate cherry, rúcula, pepino, naranja, camarones)", precio: 620 },
    ]
  },
